...
class UpdateCampaignMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('frontoffice.email.update_campaign', compact('phone_number', 'email', 'social_media'))->subject('Kabar Terbaru');
    }
}
