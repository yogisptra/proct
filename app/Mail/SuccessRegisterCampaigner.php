...
class SuccessRegisterCampaigner extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('frontoffice.email.success_register-campaigner', compact('phone_number', 'email', 'social_media'))
            ->subject('Sukses Daftar Campaigner')
            ->with([
                'data' => $this->data,
                'note' => $this->note,
            ]);
