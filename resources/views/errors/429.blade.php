...
<head>
    ...
    <!-- TITLE-->
    <title>Halaman Tidak Ditemukan - Donasi.Co</title>
    ...
    <!-- Vendor style -->
    <link rel="stylesheet" type="text/css" href="c{{ asset('frontoffice/assets/css/vendor/swiper.min.css') }}">
</head>
...
<body class="preload">
        ...
        <section class="maxview-full bg-white px-ss-2 pt-6 pb-8">
            <div class="container">
                <div class="text-center"><i class="rck ryd-sad text-30 text-primary"></i>
                    <h1 class="h2 text-center mt-2">429</h1>
                    <p class="text-center mt-2">Sepertinya kakak tersesat nih. Jangan khawatir, aku antar kakak kembali ke beranda.</p><a class="link-btn link-btn-primary h-12 w-full rounded-xs fw-medium mt-8" href="{{ route('frontoffice') }}">Kembali Ke Beranda</a>
                </div>
            </div>
        </section>
    </main>
    ...
    <script src="{{ asset('frontoffice/assets/js/vendor/popper.min.js') }}"></script>
    <script src="{{ asset('frontoffice/assets/js/vendor/ripples.js') }}"></script>
    <script src="{{ asset('frontoffice/assets/js/vendor/bootstrap.min.js') }}"></script>
    <script src="{{ asset('frontoffice/assets/js/vendor/clipboard.min.js') }}"></script>
