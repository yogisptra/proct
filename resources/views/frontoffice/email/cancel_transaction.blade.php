      ...
      <div class="email-container" style="max-width: 680px; margin: auto;">
        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="        max-width: 680px;        overflow:hidden;        background-color: white;">
          ...
          <tbody>
                      ...
                      <td style="padding:0 24px; font-size: 16px; line-height: 26px; color: #555555;">
                        <div class="body-wrapper">
                          <div class="text-wrapper">
                            <div class="title__">Komitmen Anda Dibatalkan</div>
                            {{-- <div class="group">
                              <p>Assalamu'alaikum Warohmatullahi Wabarokaatuh {{ $data->name }},<br><br> Komitmen anda pada program <b>{{ ($data->hasCampaign->title) ?? $data->type_transaction_id }}</b></p><br>
                              <p class="error">TELAH DIBATALKAN</p>
                              <p>Nominal: <span class="primary">Rp{{number_format($data['amount']+$data['unique_code'],0,'.','.')}},-</span><br><b>{{ Carbon\Carbon::parse($data->transaction_date)->translatedFormat('l') }}, {{ Carbon\Carbon::parse($data->transaction_date)->translatedFormat('d F Y') }}</b><br>  
                                No. Transaksi <b>{{ $data->transaction_number }}</b></p>
                            </div>
                            <div class="group">
                              ...
                              <a href="{{ route('dashboard-confirmation_manualTransaction', $data->transaction_number) }}" target="_blank">https://donasi.co/konfirmasi-pembayaran</a>
                            </div> --}}
                            {!! $note !!}
                          </div>
                        </div>
            ...
            <tr>
                <td align="center" valign="middle" style="height: 160px;" class="footer">
                    <div>
