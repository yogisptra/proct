                      ...
                      <td style="padding:0 24px; font-size: 16px; line-height: 26px; color: #555555;">
                        <div class="body-wrapper">
                          <div class="text-wrapper">
                            <div class="title__">Terima Kasih</div>
                            {{-- <div class="group">
                              <p>Assalamu'alaikum Warohmatullahi Wabarokaatuh {{ $data->name }},<br><br>Kami telah menerima kebaikan anda pada program {{ ($data->hasCampaign->title) ?? $data->type_transaction_id }} sebesar :</p>
                              <p class="primary">Rp{{number_format($data['amount']+$data['unique_code'],0,'.','.')}},-</p>
                              <p><b>{{ Carbon\Carbon::parse($data->transaction_date)->translatedFormat('l') }}, {{ Carbon\Carbon::parse($data->transaction_date)->translatedFormat('d F Y') }}</b><br>No. Transaksi <b>{{ $data->transaction_number }}</b></p>
                            </div>
                            <div class="group">
                              <p>Terima kasih sudah berbagi kebaikan di <b>Donasi.Co</b>, Ayo bantu program lainnya yang butuh kebaikan anda dengan klik tautan dibawah ini:</p><a href="{{ route('frontoffice') }}" target="_blank">https://donasi.co</a>
                            </div> --}}
                            {!! $note !!}
                          </div>
                        </div>
