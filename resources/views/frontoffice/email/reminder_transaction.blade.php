                      ...
                      <td style="padding:0 24px; font-size: 16px; line-height: 26px; color: #555555;">
                        <div class="body-wrapper">
                          <div class="text-wrapper">
                            <div class="title__">Jangan Lupa Komitmen Sedekah</div>
                            <div class="group">
                              <p>Assalamu'alaikum Warohmatullahi Wabarokaatuh {{ $data->name }},<br><br> Jangan lupa lakukan komitmen Anda pada program <b>{{ ($data->hasCampaign->title) ?? $data->type_transaction_id }}</b></p><br>
