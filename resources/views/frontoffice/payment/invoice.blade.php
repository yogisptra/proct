    ...
    <main class="mt-18">
        <section class="maxview align-items-start bg-white px-ss-2 pt-6 pb-8">
            <div class="container">
                ...
                </div><a class="link-btn link-btn-primary h-12 w-full rounded-xs fw-medium mt-8" href="{{ route('dashboard-confirmation_manual') }}">Konfirmasi Pembayaran</a><a class="link-btn link-btn-primary-o h-12 w-full rounded-xs fw-medium mt-4" href="{{ route('frontoffice') }}"><span>Kembali Ke Beranda</span><i class="text-default ms-2 rck ryd-arrow-right"></i></a>
            </div>
        </section>
    </main>
