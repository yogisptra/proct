    ...
    <section class="maxview align-items-start bg-white pt-6 pb-30">
        <div class="container">
            <div class="d-flex align-items-center">
                <a href="{{ route('setting-campaignerCorporate', $data->encodeHash($data->id)) }}">
                    <div class="bg-skeleton overflow-hidden w-18 w-ss-20_5 h-18 h-ss-20_5 rounded-circle shadow">
                        <img class="w-full h-full object-cover" src="{{ asset('assets/images/corporate/'. $data->image) }}" alt="User Picture">
                    </div>
                </a>
                <div class="ps-3 ps-ss-4 flex-1">
                    <div class="d-flex align-items-center">
                        <p class="text-base text-default text-ss-xl fw-medium line-clamp-1">{{ $data->corporate_name }}</p>
                        <i class="ms-1 text-primary rck ryd-verified-simple"></i>
                    </div>
                    <p class="text-xs text-ss-sm line-clamp-1">{{ Auth::guard('member')->user()->name }}</p>
            ...
            <div class="row mt-4 mt-ss-6 gy-3 gx-4">
                <div class="col-12 col-ss-6"><a class="d-block text-base-light py-3 px-4 rounded-xs shadow-drop" href="{{ route('dashboard-myDonation') }}"><i class="text-xl text-primary rck ryd-heart"></i><span class="d-block text-sm line-clamp-1 mt-2">Dana Terkumpul</span>
            ...
            <ul>
                ...
                <li class="mt-6"><a class="d-flex align-items-center" href="{{ route('setting-campaignerCorporate', $data->encodeHash($data->id)) }}"><i class="rck ryd-setting link-primary text-2xl me-4"></i><span class="link-base text-default fw-bold">Pengaturan</span></a>
                </li>
            </ul>
