...
@section('content')
    ...
    <main class="mt-18">
        <section class="maxview align-items-start bg-white px-ss-2 pt-6 pb-8">
            ...
            <div class="container">
                <form action="{{ route('store-registrasiCorporateCampaigner') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="type_campaigner" value="{{ $type }}">
                    <div class="tab-content mt-6">
                        <div class="tab-pane active" id="tab-corporate">
                            <div>
                                <label class="user-select-none text-xs fw-medium mb-2">Jenis Lembaga<span class="mt-2 text-xs text-danger">*</span>
                                </label>
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-id-card {{ $errors->has('type_corporate') ? 'text-danger' : 'text-primary' }}"></i>
                                    <select class="select-with-search" name="type_corporate" id="type_corporate" required>
                                        <option selected disabled>Pilih Jenis Lembaga</option>
                                        @foreach ($typeCorporate as $row)
                            ...
                            <div class="mt-4">
                                <label class="user-select-none text-xs fw-medium mb-2">Nama Perusahaan / Yayasan / Organisasi<span class="mt-2 text-xs text-danger">*</span>
                                </label>
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-user {{ $errors->has('corporate_name') ? 'text-danger' : 'text-primary' }}"></i>
                                    <input class="input ps-12" type="text" placeholder="Nama Perusahaan" name="corporate_name" required>
                                </div>
                            ...
                            <div class="mt-4">
                                <label class="user-select-none text-xs fw-medium mb-2">Email<span class="mt-2 text-xs text-danger">*</span>
                                </label>
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-mail {{ $errors->has('corporate_email') ? 'text-danger' : 'text-primary' }}"></i>
                                    <input class="input ps-12" type="text" placeholder="Email Perusahaan" name="corporate_email" required>
                                </div>
                            ...
                            <div class="mt-4">
                                <label class="user-select-none text-xs fw-medium mb-2">Nomor Telepon<span class="mt-2 text-xs text-danger">*</span>
                                </label>
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-calling {{ $errors->has('corporate_phone_number') ? 'text-danger' : 'text-primary' }}"></i>
                                    <input class="input ps-12" type="number" placeholder="Nomor Telepon Perusahaan" name="corporate_phone_number" required>
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="position-relative h-11"><i class="position-absolute right-4 top-3_5 text-default rck ryd-chevron-down z-1 {{ $errors->has('corporate_country') ? 'text-danger' : 'text-primary' }}"></i>
                                    <select class="select-with-search" name="corporate_country" id="corporate_country" required>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-map {{ $errors->has('corporate_address') ? 'text-danger' : 'text-primary' }}"></i>
                                    <textarea class="input ps-12" placeholder="Jl. Venus No. 1" name="corporate_address" required></textarea>
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-postal {{ $errors->has('corporate_codepos') ? 'text-danger' : 'text-primary' }}"></i>
                                    <input class="input ps-12" type="number" placeholder="40000" name="corporate_codepos" required>
                                </div>
                            ...
                            <div class="mt-4">
                                <label class="user-select-none text-xs fw-medium mb-2">NIB<span class="d-inline-block text-xxs text-gray ms-1">(Max. 1MB, Jenis File JPG/PNG)</span>
                                </label>
                                <div class="position-relative">
                                    <label class="upload-img d-block bg-gray-light bg-opacity-30 rounded-xs overflow-hidden position-relative">
                                        <input class="d-none" name="nib" type="file" id="uploadNibBtn" accept="image/png, image/jpeg">
                                        <div class="upload-img__label position-absolute d-flex align-items-center top-half left-half translate-nhalf user-select-none cursor-pointer"><i class="rck ryd-thumb text-primary text-default me-2"> </i><span class="text-xs">Unggah NIB</span>
                                        </div>
                                        <img class="w-full cursor-pointer position-relative" id="uploadNib" src="{{ asset('frontoffice/assets/img/upload-wrapper.webp') }}" alt="Background Upload Wrapper">
                                    </label>
                                </div>
                                @if ($errors->has('nib'))
                                    <span class="mt-2 text-xs text-danger">{{ $errors->first('nib') }}</span>
                            ...
                            <div class="mt-4">
                                <label class="user-select-none text-xs fw-medium mb-2">Cover Legalitas Lembaga<span class="mt-2 text-xs text-danger">*</span><span class="d-inline-block text-xxs text-gray ms-1">(Max. 1MB, Jenis File JPG/PNG)</span>
                                </label>
                                <div class="position-relative">
                                    <label class="upload-img d-block bg-gray-light bg-opacity-30 rounded-xs overflow-hidden position-relative">
                            ...
                            <div class="mt-4">
                                <label class="user-select-none text-xs fw-medium mb-2">Unggah Logo<span class="mt-2 text-xs text-danger">*</span><span class="d-inline-block text-xxs text-gray ms-1">(Max. 1MB, Jenis File JPG/PNG)</span>
                                </label>
                                <div class="position-relative">
                                    <label class="upload-img d-block bg-gray-light bg-opacity-30 rounded-xs overflow-hidden position-relative">
                                        <input class="d-none" name="image" type="file" id="uploadLogoBtn" accept="image/png, image/jpeg">
                        ...
                        <div class="tab-pane" id="tab-responsible">
                            <div>
                                ...
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-id-card {{ $errors->has('nik_pic') ? 'text-danger' : 'text-primary' }}"></i>
                                    <input class="input ps-12" maxlength="16" name="nik_pic" type="number" placeholder="32**************" value="{{ old('nik_pic') }}" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-user {{ $errors->has('name_pic') ? 'text-danger' : 'text-primary' }}"></i>
                                    <input class="input ps-12" name="name_pic" type="text" placeholder="Nama Lengkap" value="{{ old('name_pic') }}" required>
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-mail {{ $errors->has('email_pic') ? 'text-danger' : 'text-primary' }}"></i>
                                    <input class="input ps-12" name="email_pic" type="text" placeholder="Email" value="{{ old('email_pic') }}" required>
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-calling {{ $errors->has('phone_number_pic') ? 'text-danger' : 'text-primary' }}"></i>
                                    <input class="input ps-12" name="phone_number_pic" type="number" placeholder="Nomor Telepon" value="{{ old('phone_number_pic') }}" required>
                                </div>
                            ...
                            <div class="mt-4">
                                <label class="user-select-none text-xs fw-medium mb-2">Unggah KTP<span class="mt-2 text-xs text-danger">*</span><span class="d-inline-block text-xxs text-gray ms-1">(Max. 5MB, Jenis File JPG/PNG)</span>
                                </label>
                                <div class="position-relative">
                                    <label class="upload-img d-block bg-gray-light bg-opacity-30 rounded-xs overflow-hidden position-relative">
                            ...
                            <div class="mt-4">
                                <label class="user-select-none text-xs fw-medium mb-2">Unggah KTP + Selfie<span class="mt-2 text-xs text-danger">*</span><span class="d-inline-block text-xxs text-gray ms-1">(Max. 5MB, Jenis File JPG/PNG)</span>
                                </label>
                                <div class="position-relative">
                                    <label class="upload-img d-block bg-gray-light bg-opacity-30 rounded-xs overflow-hidden position-relative">
                            ...
                            <label class="cb mt-4">
                                <div class="cb__box" id="terms">
                                    ...
                                    <div></div>
                                </div><span class="user-select-none ms-3">Kami menyatakan bahwa segala data yang diberikan adalah benar.</span>
                            </label>
                            <div class="row gx-4 mt-8">
                                ...
                                <div class="col-6">
                                    <input disabled class="link-btn link-btn-primary h-12 w-full rounded-xs fw-medium submit" type="submit" value="Kirim">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        //- Upload KTP
          ...
          function readURL5(input) {
              ...
              reader.onload = function (e) {
                  $('#uploadNib').attr('src', e.target.result);
              }
              reader.readAsDataURL(input.files[0]);
              }
          }
          
          $("#uploadNibBtn").change(function(){
              readURL5(this);
          });
