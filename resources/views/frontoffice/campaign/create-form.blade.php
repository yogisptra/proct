    ...
    <nav class="navbar transition-all position-fixed w-full top-0 left-0 z-1050 bg-white">
        <div class="container">
            <div class="h-18 d-flex justify-content-between align-items-center position-relative">
                <div class="navbar__left d-flex align-items-center"><a class="d-flex align-items-center link-base me-4" href="javascript:history.go(-1)" aria-label="Go Back"><i class="text-2xl rck ryd-arrow-left"></i></a><span class="line-clamp-1 text-base fw-medium text-default">Buat Campaign</span>
                </div>
            ...
            <div>
                <div class="mx-ss-n2 d-none">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <button class="fw-medium" data-bs-target="#tab-step3" data-bs-toggle="tab"></button>
                        </li>
                    </ul>
                </div>
                <div class="container">
                    <div class="step-wizard mb-6"><span class="_active" id="sw1">1</span><span id="sw2">2</span><span id="sw3">3</span>
                    </div>
                            ...
                            <div class="tab-pane active" id="tab-step1">
                                ...
                                <label class="cb mt-4">
                                    <div class="cb__box" id="terms">
                                        <input class="d-none" value="1" type="checkbox">
                                        <div></div>
                                    </div><span class="user-select-none ms-3">Dengan ini anda setuju <b class="link-primary">Syarat & Ketentuan</b> yang berlaku</span>
                                </label><a class="submit link-btn link-btn-primary h-12 w-full mt-8 rounded-xs fw-medium" data-button="next" disabled><span>Selanjutnya</span><i class="text-default ms-2 rck ryd-arrow-right"></i></a>
                            </div>
                            <div class="tab-pane" id="tab-step2">
                                <div>
                                    ...
                                    <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-campaign {{ $errors->has('title') ? 'text-danger' : 'text-primary' }}"></i>
                                        <input class="input ps-12" name="title" value="{{ old('title') }}" id="title" type="text" onkeyup="url()" placeholder="Bantuan Untuk Saudara Kita">
                                    </div>
                                    @if ($errors->has('title'))
                                ...
                                <div>
                                    <label class="user-select-none text-xs fw-medium mb-2">Link
                                    </label>
                                    <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-info {{ $errors->has('slug') ? 'text-danger' : 'text-primary' }}"></i>
                                        <input class="input ps-12" name="slug" value="{{ old('slug') }}" id="slug" type="text" placeholder="Link Slug">
                                    </div>
                                    @if ($errors->has('slug'))
                                        <span class="mt-2 text-xs text-danger">{{ $errors->first('slug') }}</span>
                                    @endif
                                </div>
                                <label class="cb mt-4" id="openGoal">
                                    <div class="cb__box">
                                        <input class="d-none" value="1" name="open_goal" type="checkbox">
                                        <div></div>
                                    </div>
                                ...
                                <div class="mt-4 non-open-goal">
                                    ...
                                    <div class="position-relative"><i class="position-absolute right-4 top-3_5 text-default rck ryd-calendar"></i>
                                        <input class="input pe-12 datepicker-input" name="valid_date" type="text" placeholder="TT/BB/TTTT" inputmode="numeric" data-type="currency" autocomplete="off" id="datepicker">
                                    </div>
                                </div>
                                <div class="mt-4 non-open-goal">
                                    ...
                                    <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-rp text-2xl text-primary" style="top: 0.6875rem !important;"></i>
                                        <input class="input ps-12 text-end fw-bold text-primary text-default py-2_25" name="target" value="{{ old('target') }}" id="target" type="text" placeholder="50.000" inputmode="numeric" data-type="currency">
                                    </div>
                                ...
                                <div class="mt-4">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <label class="user-select-none text-xs fw-medium mb-2" style="margin-bottom: 0 !important;">Opsi Donasi
                                    ...
                                    <div class="row g-2" id="customNominal">
                                        <div class="col-12">
                                            <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-rp text-primary"></i>
                                                <input class="input ps-12 text-end fw-bold text-primary" name="custom_amount[]" multiple="multiple" value="" type="text" placeholder="50.000" inputmode="numeric" data-type="currency">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-rp text-primary"></i>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="position-relative">
                                        <label class="upload-img d-block bg-gray-light bg-opacity-30 rounded-xs overflow-hidden position-relative">
                                            ...
                                            <img class="w-full cursor-pointer position-relative" id="uploadThumb" src="{{ asset('frontoffice/assets/img/upload-wrapper.webp') }}" alt="Background Upload Wrapper">
                                        </label>
                                    </div>
                                    @if ($errors->has('image'))
                                ...
                                <div class="row gx-4 mt-8">
                                    ...
                                    <div class="col-6"><a class="submit link-btn link-btn-primary h-12 w-full rounded-xs fw-medium" data-button="next" disabled><span>Selanjutnya</span><i class="text-default ms-2 rck ryd-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-step3">
                                <div>
                                    ...
                                    <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-id text-primary"></i>
                                        <input class="input ps-12" name="fb_pixel" value="{{ old('fb_pixel') }}" type="text" placeholder="928**********">
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="position-relative"><i class="position-absolute left-4 top-3_5 text-default rck ryd-google text-primary"></i>
                                        <input class="input ps-12" name="gtm" value="{{ old('gtm') }}" type="text" placeholder="GTM-*********">
                                    </div>
                                </div>
                                <div class="row gx-4 mt-8">
                                    <div class="col-6"><a class="link-btn link-btn-primary-o h-12 w-full rounded-xs fw-medium" data-button="prev"><span>Kembali</span></a>
                                    ...
                                    <div class="col-6">
                                        <button class="link-btn link-btn-primary h-12 w-full rounded-xs fw-medium" type="submit"><span>Buat Campaign</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
        ...
        //
          ...
          $('[data-button="next"], [data-button="prev"]').click(function(){
              if ($("[data-bs-target='#tab-step1']").hasClass('active')) {
                  ...
                  $('.step-wizard #sw1').addClass('_active')
          
              } else if ($("[data-bs-target='#tab-step2']").hasClass('active')) {
                  $('.step-wizard span').removeClass('_active')
                  $('.step-wizard #sw1').addClass('_active')
                  $('.step-wizard #sw2').addClass('_active')
              } else if ($("[data-bs-target='#tab-step3']").hasClass('active')) {
                  $('.step-wizard #sw1').addClass('_active')
                  $('.step-wizard #sw2').addClass('_active')
