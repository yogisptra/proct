...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12">
        <div class="d-flex justify-content-end " role="group" aria-label="Button Group">
            <a href="{{ route('campaign-approval.index') }}" type="button" class="btn btn-info mr-1 round">
                Kembali
            </a>
        </div>
    </div>
                                    ...
                                    <form class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        {{-- <img src="{{ asset('assets/images/campaign/'. $data->image_main) }}" class="img-thumbnail" width="100%"> --}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <span>: <a target="_blank" href="{{ config('app.url')}}/program/{{ $data->slug ? ($data->slug) : '-' }}">{{ config('app.url') }}/program/{{ $data->slug ? ($data->slug) : '-' }}</a> </span>
                                                    </div>
                                                </div>
                                            </div>
