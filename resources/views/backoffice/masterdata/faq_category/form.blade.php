        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">FAQ Kategori</li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form action="{{ @$data->id ? route('faq_categories.update', @$data->id) : route('faq_categories.store') }}" method="POST" class="form form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" name="name" value="{{ @$data->name ?? old('name') }}" id="name" class="form-control" placeholder="Nama FAQ Kategori" required>
                                                @if ($errors->has('name'))
                                    ...
                                    <div class="form-actions">
                                        <a href="{{ route('faq_categories.index') }}" type="button" class="btn btn-warning mr-1 round">
                                            Kembali
                                        </a>
