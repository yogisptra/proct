            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form action="{{ @$data->id ? route('banks.update', @$data->id) : route('banks.store') }}" method="POST" class="form form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" name="name" value="{{ @$data->name ?? old('name') }}" id="name" class="form-control" placeholder="Nama Bank" required>
                                                @if ($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6-lg-10 ml-1">
                                                <img id="showImg" src="{{ @$data->image ? asset('assets/images/bank/'. @$data->image) : 'https://placehold.it/180' }}" style="padding-bottom: 10px; width: 300px;"/>
                                                @if ($errors->has('image'))
                                    ...
                                    <div class="form-actions">
                                        <a href="{{ route('banks.index') }}" type="button" class="btn btn-warning mr-1 round">
                                            Kembali
                                        </a>
